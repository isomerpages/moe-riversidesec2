...
permalink: /sec-1-registration-2026/start-it-right-and-secondary-one-orientation-programme/
variant: markdown
description: ""
...
<table style="border-collapse: collapse; width: 100%; border: 1px solid lightgrey;">
  ...
  <tbody>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><strong>Start it right!</strong></td>
      <td><strong>Secondary One Orientation Programme</strong></td>
    </tr>
    <tr>
      <td><strong>Date</strong></td>
      <td>2<sup>nd</sup> Jan 2026 (Fri)</td>
      <td>5<sup>th</sup> Jan 2026 (Mon)</td>
      <td>6<sup>th</sup> – 7<sup>th</sup> Jan 2026 (Tues &amp; Wed)</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3">
        Classroom of the student's form class <br>
        (Note: You can check your child/ward’s form class via Parents Gateway (PG) on 31 Dec 2025)
      </td>
    </tr>
    <tr>
...
<tr>
  <td>&nbsp;</td>
<td colspan="2">
  <div style="display: flex; gap: 8px;" class="uniform-pair">
    <div style="flex: 1;" class="isomer-image-wrapper">
      <img style="width: 100%; height: 85%; object-fit: contain;" alt="Photo 1" src="/images/S1%20Registration/School_Uniform__Boy_.png">
    </div>
    <div style="flex: 1;" class="isomer-image-wrapper">
      <img style="width: 100%; height: 100%; object-fit: contain;" alt="Photo 2" src="/images/S1%20Registration/School_Uniform__Girl_.png">
    </div>
  </div>
</td>
  <td>
  ...
  <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="3">
        As the first four days of school will be days of orientation and administration, it is not necessary to bring any textbooks to school.
      </td>
    </tr>
  </tbody>
</table>